...
char orgpass[20] = "STGY@cseb";
char orguser[20] = "Admin";
//----------------------------------------------------------------
...
void profilechange(){
    ...
    printf("\nEnter New Username: ");
    scanf("%s",user_new);
    strcpy(orguser, user_new);

    printf("\nEnter the no. of chars involved in the new password:  ");
        scanf("%d", &p);
        printf("\nEnter New Password: ");
        for(i=0;i<p;i++){
            pass_new[i]=getch();
...
void createCandidateFiles(){
    ...
    printf("Prepared Candidates successfully\n");
}
        ...
        while(1)
        {
            ...
            switch(input)
            {
                ...
                case 5:
                    ...
                    printf("\nVoting Percentage: %.3f %%\n\n",(float)(totalVotedNow*100)/currentValidID.totalVoters);
                    break;
                case 6:
                    profilechange();
                case 7:
